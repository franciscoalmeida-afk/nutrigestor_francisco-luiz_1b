...
\restrict IWoIk9tKgqb63bFAu30b4Eg6H8QPGu8KixUOp8eVxJBzhd7BvFvKa5M7Yzt4JlP
...
CREATE TABLE public.cardapio (
    id integer NOT NULL,
    data date NOT NULL,
    "descrição" character varying(200) NOT NULL,
    intens_utilizados text
);
...
COPY public.cardapio (id, data, "descrição", intens_utilizados) FROM stdin;
1	2026-06-29	arroz temperaado	arroz e legumes
2	2026-06-30	macarrão	macarrão e carne moida
...
1	arroz	35.75	2026-06-09
2	feijão	75.12	2026-06-29
3	macarrão	37.13	2026-06-29
\.
...
--
-- Name: item_restricao pk_ir_restricao; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.item_restricao
    ADD CONSTRAINT pk_ir_restricao FOREIGN KEY (id_restricao) REFERENCES public.restricao(id) ON DELETE CASCADE;
...
\unrestrict IWoIk9tKgqb63bFAu30b4Eg6H8QPGu8KixUOp8eVxJBzhd7BvFvKa5M7Yzt4JlP
